...
| Ground grid | White lines | 10 m cells; covers ±1500 m in each direction |
...
| Action | Effect |
|---|---|
| Right-mouse drag | Orbit camera around the launcher–target midpoint |
| Scroll wheel | Zoom in / out (5 m to 8 km) |
